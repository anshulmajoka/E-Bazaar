...
public class SimpleConnectionPool {
     ...
     * default driver
     */
    public static synchronized SimpleConnectionPool getInstance(int maxconn)
            throws DatabaseException {
        return getInstance("", "", "", maxconn);
    }

    public static synchronized SimpleConnectionPool getInstance(String dbuser,
    ...
    public synchronized Connection getConnection(String URI) throws DatabaseException {
	...
	public static Connection productConnection() throws DatabaseException {
		try {
			return getInstance("root", "root", "com.mysql.jdbc.Driver", 1).getConnection("jdbc:mysql://localhost:3306/ProductsDb");
		} catch (Exception e) {
