...
public class OrderUtil { 
    ...
    public static List<String[]> makeItemsDisplayable(List<IOrderItem> orderItems) throws DatabaseException  {
        ...
        TwoKeyHashMap<Integer,String,IProductFromDb> productTable = 
        	(new ProductSubsystemFacade()).getProductTable();
    ...
    public static List<String[]> extractOrderData(List<IOrder> ordersList){
        //IMPLEMENTIOrder order = 
			(new OrderSubsystemFacade(null)).createOrder(1, "11/11/2011","20.20");
		String[] orderAsList = {"1", "11/11/2011","20.20"};
